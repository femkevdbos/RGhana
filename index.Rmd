...
- Part C: Data manipulation
    ...
    - [Solutions to Practical C](Contents/Material/Part C - Data manipulation/Practical_C_Simon.html)
...
- [Reformatting Code Warehousing](Contents/Material/Trade/Trade_formatting_warehousing.Rmd){target="_blank"}
- [Reformatting Code Regime 9](Contents/Material/Trade/Trade_formatting_reg9.Rmd){target="_blank"}
- [Trade vulnerability ICUMS](Contents/Material/Trade/Trade vulnerability ICUMS.R){target="_blank"}
- [Assignment 4 -initial script](Contents/Material/Trade/Assignment 4 - initial script.R){target="_blank"}
...
| *13-17 Feb*  |    Wednesday 13.00-15.00  | Discuss Assignment 1 |
|              |                         | + Intro to analyzing ICUMS |
| *20-24 Feb*  |    Wednesday 13.00-15.00  | Analyzing ICUMS data - go through code, part 1 |
| *27-3 Feb/Mar*  |    Tuesday 13.00-15.00  | Discuss Assignment 2 + Visualizations |
| *6-10 Mar*  |    XXX  | No meeting |
| *13-17Mar*  |    Wednesday 13.00-15.00  | Visualizations + apply to trade data |
| *20-24 Mar*  |    XXX  | No meeting |
| *27-31 Mar*  |    Wednesday 13.00-15.00  | Start working on Assignment 4 |
| *3-7 Apr*  |    Wednesday 13.00-15.00  | More on Assignment 4 |
| *10-14 Apr*  |    XXX  | No meeting |
| *17-21 Apr*  |    Wednesday 12.00-lunch/dinner  | Recap lecture + way forward |
| *24-28 Apr*  |    XXX  | Independent work on Assignment 4 + Recap |
| *1-5 May*  |    XXX | Work on Practical Assignment 5 |


# After the training: CPI

## Column 1

### Introduction
As discussed at the end of the R training (30 Jan - 3 Feb & 7-9 Feb) we agreed on a longer term plan to improve the R skills of the CPI team. We will have assignments every 2 weeks to keep on practicing R. Besides that, I am available for any questions, so always feel free to come by my office (332), or to text/call me to schedule a meeting.

It must be noted that your own motivation and dedication will determine how much progress you make. The more time you invest in learning R, the better you will get of course! Therefore, I would like this progress to be very much driven by what you want to learn, so please come up with topics to discuss yourself as well and I will adjust the assignments based on that.

### Material to use
Create a CPI R folder and project on your computer, and always work from there. Below please find the R scripts we will work with, as well as the assignments and their solutions. 

R scripts:

- [CPI Indices Code](Contents/Material/CPI/CPI_indices_code_nocomments.R){target="_blank"}


### Assignments + solutions
Assignments:

- [Assignment 1 (Deadline: 27-02)](Contents/Material/CPI/Assignments/CPI_Assignment_1.html){target="_blank"}
- [Assignment 2 (Deadline: 13-03)](Contents/Material/CPI/Assignments/CPI_Assignment_2.html){target="_blank"}

Solutions to assignments:

- [Solution to Assignment 1](Contents/Material/CPI/Assignments/CPI_solution_1.html){target="_blank"}

# After the training: Industry

## Column 1

### Introduction
As discussed at the end of the R training (30 Jan - 3 Feb) we agreed on a longer term plan to improve the R skills of the Business and Industry team. We will have assignments to keep on practicing R. Besides that, I am available for any questions, so always feel free to come by my office (332), or to text/call me to schedule a meeting.

It must be noted that your own motivation and dedication will determine how much progress you make. The more time you invest in learning R, the better you will get of course! Therefore, I would like this progress to be very much driven by what you want to learn, so please come up with topics to discuss yourself as well and I will adjust the assignments based on that.

### Material to use
Create a "Practicing R" folder on your computer, as well as an R project in that folder, and always work from there. Below please find the assignments and their solutions. 

### Assignments + solutions
Assignments:

- [Assignment 1 (Deadline: 15-05)](Contents/Material/Industry/Industry_Assignment_1.html){target="_blank"}
